...
A) \begin{tikzpicture}[baseline={([yshift={-1ex}]current bounding box.north)}, scale=0.50]
    \begin{axis}[my style, minor tick num=1]
...
E) \begin{tikzpicture}[baseline={([yshift={-1ex}]current bounding box.north)}, scale=0.50]
    ...
    \end{axis}
\end{tikzpicture}
F) \begin{tikzpicture}[baseline={([yshift={-1ex}]current bounding box.north)}, scale=0.50]
    \begin{axis}[my style, minor tick num=1]
