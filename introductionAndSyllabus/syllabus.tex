...
\begin{question}
    ...
    \begin{question}
        Why not?
        \begin{multipleChoice}
            \choice{Contesting grades is just going to annoy the grader and ensure you won't get anywhere.}
            \choice{You should email the instructure instead; the squeaky wheel gets the grease.}
            \choice[correct]{The One-Week policy in the syllabus already says you won't get a grade change.}
            \choice{You should talk to your TA and try to get the grade changed regardless.}
        \end{multipleChoice}
    \end{question}
\end{question}
