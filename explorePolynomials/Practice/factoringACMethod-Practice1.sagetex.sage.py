...
_sage_const_66 = Integer(66); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_3 = Integer(3); _sage_const_95 = Integer(95); _sage_const_84 = Integer(84); _sage_const_10 = Integer(10); _sage_const_57 = Integer(57); _sage_const_75 = Integer(75); _sage_const_52 = Integer(52)## This file (factoringACMethod-Practice1.sagetex.sage) was *autogenerated* from factoringACMethod-Practice1.tex with sagetex.sty version 2015/08/26 v3.0-92d9f7a.
import sagetex
...
try:
 ...
 _st_.inline(_sage_const_2 , latex(p2f3))
except:
...
try:
 ...
 _st_.inline(_sage_const_4 , latex(p3f3))
except:
...
try:
 ...
 _st_.inline(_sage_const_6 , latex(p4f3))
except:
 _st_.goboom(_sage_const_84 )
try:
 _st_.current_tex_line = _sage_const_84 
 _st_.inline(_sage_const_7 , latex(p4f3))
except:
 _st_.goboom(_sage_const_84 )
_st_.endofdoc()
