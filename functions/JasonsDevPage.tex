...
%%%         Coloring Information
        linecolor=          blue,%        Set the border line coloring to a defined color, so users can change it as desired.
        backgroundcolor=purple,%        Set the background coloring to a user definable color.
